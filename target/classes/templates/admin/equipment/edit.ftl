...
<head>
    ...
    <title>系统设置-器材管理--器材基本管理---编辑</title>
        ...
        <main class="lyear-layout-content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header"><h4>编辑器材</h4></div>
                            <div class="card-body">

                                <form id="equipment_add_form" action="add" method="post" class="row">
                                    <input type="hidden" name="id" id="id" value="${equipment.id}">
                                    <div class="form-group col-md-12">
                                        <label for="title">器材名称</label>
                                        <input type="text" class="form-control required" id="equipmentname" name="equipmentname" value="${equipment.equipmentname}" placeholder="请输入用户名" tips="请填写用户名" />
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="seo_keywords">器材描述</label>
                                        <input type="text" class="form-control required" id="description" name="description" value="${equipment.description}" placeholder="请输入密码" tips="请填写密码"/>
                                    </div>
                                    <div class="form-group col-md-12">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#add-form-submit-btn").click(function () {
            if(!checkForm("equipment_add_form")){
                return;
            }
            var id =  $("#id").val();
            ...
            $.ajax({
                url: 'edit',
                type: 'POST',
                data: {id: id,equipmentname: equipmentname, description: description},
                dataType: 'json',
                success: function (data) {
                    if (data.code == 0) {
                        showSuccessMsg('器材编辑成功',function () {
                            window.location.href = 'equipment_list';
                        })
