                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-toolbar clearfix">
                                <form class="pull-right search-bar" method="get" action="equipment_list" role="form">
                                    <div class="input-group">
                                        <div class="input-group-btn">
                                            <button class="btn btn-default dropdown-toggle" id="search-btn"
                                                    data-toggle="dropdown" type="button" aria-haspopup="true"
                                                    aria-expanded="false">
                                                器材名称 <span class="caret"></span>
                                            </button>
                                            <ul class="dropdown-menu">
                                                <li><a tabindex="-1" href="javascript:void(0)"
                                                       data-field="title">器材名称</a></li>
                                            </ul>
                                        </div>
                                        <input type="text" class="form-control" value="${equipmentname!""}" name="equipmentname"
                                               placeholder="请输入器材名称">
                      ...
                      <button class="btn btn-primary" type="submit">搜索</button>
                                ...
                                <div class="toolbar-btn-action">
                                    <a class="btn btn-primary m-r-5" href="/equipment/add"><i class="mdi mdi-plus"></i>
                                        新增</a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <#if pageBean.content?size gt 0>
                                            <#list  pageBean.content as equipment>
                                                <tr>
                                                    <td>
                                                        <label class="lyear-checkbox checkbox-primary">
                                                            <input type="checkbox" name="ids[]"
                                                                   value="${equipment.id}"><span></span>
                                                        </label>
                                                    </td>
                                                    <td>${equipment_index+1}</td>
                                                    <td><b>${equipment.equipmentname}</b></td>
                                                    <td>${equipment.description}</td>
                                                    <td>${equipment.creaTime}</td>
                                                </tr>
                                            </#list>
                                        <#else>
                                            <tr align="center"><td colspan="9">这里空空如也！<a href="equipment_list">显示全部数据</a></td> </tr>
                                        </#if>
                                        </tbody>
                                    </table>
                                </div>
                                <#if pageBean.total gt 0>
                                    <ul class="pagination">
                                        ...
                                        <#else>
                                            <li><a href="equipment_list?name=${name!""}&currentPage=1">«</a></li>
                                        </#if>
                                        <#list pageBean.currentShowPage as showPage>
                                            ...
                                            <#else>
                                                <li>
                                                    <a href="equipment_list?name=${name!""}&currentPage=${showPage}">${showPage}</a>
                                                </li>
                                            </#if>
                                        </#list>
                                        <#if pageBean.currentPage == pageBean.totalPage>
                                            <li class="disabled"><span>»</span></li>
                                        <#else>
                                            <li><a href="equipment_list?name=${name!""}&currentPage=${pageBean.totalPage}">»</a>
                                            </li>
                                        </#if>
    ...
    function deleteReq(id) {
        $.ajax({
            ...
            success: function (data) {
                if (data.code == 0) {
                    showSuccessMsg('器材删除成功!', function () {
