...
<head>
    ...
    <title>系统设置-器材管理--器材维修管理---编辑</title>
        ...
        <main class="lyear-layout-content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header"><h4>编辑维修单</h4></div>
                            <div class="card-body">

                                <form id="repair_add_form" action="add" method="post" class="row">
                                    <input type="hidden" name="id" id="id" value="${repair.id}">
                                    <div class="form-group col-md-12">
                                        <label for="title">报修人姓名</label>
                                        <input type="text" class="form-control required" id="name" name="name" value="${repair.name}" placeholder="请输入用户名" tips="请填写用户名" />
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="title">电话号码</label>
                                        <input type="text" class="form-control required" id="tel" name="tel" value="${repair.tel}" placeholder="请输入用户名" tips="请填写用户名" />
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="title">器材名称</label>
                                        <input type="text" class="form-control required" id="equipmentname" name="equipmentname" value="${repair.equipmentname}" placeholder="请输入用户名" tips="请填写用户名" />
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="seo_keywords">维修问题描述</label>
                                        <input type="text" class="form-control required" id="description" name="description" value="${repair.description}" placeholder="请输入密码" tips="请填写密码"/>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="seo_keywords">状态</label>
                                        <input type="text" class="form-control required" id="status" name="status" value="${repair.status}" placeholder="请输入密码" tips="请填写密码"/>
                                    </div>
                                    <div class="form-group col-md-12">
    ...
    $(document).ready(function () {
        ...
        $("#add-form-submit-btn").click(function () {
            ...
            $.ajax({
                url: 'repair_edit',
                type: 'POST',
                data: {id: id,name: name,tel: tel,equipmentname: equipmentname, description: description,status:status},
                dataType: 'json',
